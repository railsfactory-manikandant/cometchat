...
abstract class BaseUser extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the userpwd field.
	 * @var        string
	 */
	protected $userpwd;
	...
	/**
	 * Set the value of [userpwd] column.
	 * User password
	 * @param      string $v new value
	 * @return     User The current object (for fluent API support)
	 */
	public function setUserpwd($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->userpwd !== $v) {
			$this->userpwd = $v;
			$this->modifiedColumns[] = UserPeer::USERPWD;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->useremail = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->userpwd = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->resetModified();
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::USERPWD)) $criteria->add(UserPeer::USERPWD, $this->userpwd);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setUserpwd($this->userpwd);
