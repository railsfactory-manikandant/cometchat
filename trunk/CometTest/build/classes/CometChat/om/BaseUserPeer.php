 ...
 * User Table
 *
 * @package    CometChat.om
 */
abstract class BaseUserPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'CometChat';

	/** the table name for this class */
	const TABLE_NAME = 'user';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'CometChat.User';
	...
	/** the column name for the USERPWD field */
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'Useremail', 'Userpwd', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'useremail', 'userpwd', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::USEREMAIL, self::USERPWD, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'userEmail', 'userPwd', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'Useremail' => 1, 'Userpwd' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'useremail' => 1, 'userpwd' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::USEREMAIL => 1, self::USERPWD => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'userEmail' => 1, 'userPwd' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::USEREMAIL);

		$criteria->addSelectColumn(UserPeer::USERPWD);
